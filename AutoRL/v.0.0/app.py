...
with col2:
    ...
    # Show Comparison
    if st.session_state.training_results or compare_btn:
        ...
        if valid_results:
            ...
            with st.expander("Training Logs (Comparison Plots)"):
                for res in valid_results:
                    title = f"{res['Agent']} | LR={res['LR']} | G={res['Gamma']}"
                    with st.expander(title):
                        fig_log = plot_4_panel(res['full_metrics'], title, height=500)
